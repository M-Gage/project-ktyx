...
if (inBrowser) {
  try {
    ...
    window.addEventListener('admin-passive', null, opts);
  } catch (e) {}
}
...
// these are reserved for admin because they are directly compiled away
 ...
 * - admin[test1[key]]
 * - admin["a"][key]
 * - xxx.admin[a[a].test1[key]]
 * - admin.xxx.a["asa"][test1[key]]
 *
 */
...
// check platforms/admin/util/attrs.js acceptValue
